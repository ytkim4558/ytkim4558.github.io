...
### 담당 업무
- Android, iOS 앱 기능 추가, 백엔드, 프론트 엔드 기능 추가

#### 'G.Bike' App. 기능 추가 및 DB 운영
- 기간 : 2018.06 ~ 현재
- 개요 : 공유자전거 서비스 앱의 기능 추가 및 DB 운영
- 담당 업무 : 앱 개발, DB 앱 수정
- Application URL : https://play.google.com/store/apps/details?id=com.gbike.gbike&hl=ko 
- 상세 개발 내용
1. 사용자가 탐색한 자전거가 정비중인 경우, 해당 자전거를 사용할 수 없다는 메시지 표시 기능 추가 
1. 앱 탈퇴시 보증금의 잔액에 따른 탈퇴 시나리오 작성 및 안드로이드 앱 탈퇴 기능 구현
